...
<head>
    ...
    <meta name="description" content="{{ config('app.name', 'Fursaana') }} - استعادة كلمة المرور">

    <title>{{ config('app.name', 'Fursaana') }} - استعادة كلمة المرور</title>
...
<body class="antialiased pattern-bg">
    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="forgot-card rounded-3xl p-8">
                <!-- Session Status -->
                @if (session('status'))
                ...
                <!-- Description -->
                <div class="mb-6 text-gray-600 text-lg text-center">
