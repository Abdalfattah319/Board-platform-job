...
<head>
    ...
    <meta name="description" content="{{ config('app.name', 'Fursaana') }} - تأكيد كلمة المرور">

    <title>{{ config('app.name', 'Fursaana') }} - تأكيد كلمة المرور</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('dashboard') }}" class="px-4 py-2 rounded-full text-sm font-medium text-white bg-white/20 backdrop-blur-sm border border-white/30 hover:bg-white/30 transform hover:scale-105 transition-all duration-300">
                        لوحة التحكم
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                ...
                <p class="text-white/80 text-lg">
                    هذه منطقة آمنة من التطبيق
                </p>
            </div>

            <!-- Confirm Password Form -->
            <div class="confirm-card rounded-3xl p-8">
                <!-- Security Notice -->
                <div class="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-xl text-center">
                    <div class="text-3xl mb-2">🛡️</div>
                    <p class="text-amber-800 font-medium">
                        يرجى تأكيد كلمة المرور للمتابعة إلى هذه المنطقة الآمنة
                    </p>
                </div>
