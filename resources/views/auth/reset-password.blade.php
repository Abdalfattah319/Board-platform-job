...
<head>
    ...
    <meta name="description" content="{{ config('app.name', 'Fursaana') }} - إعادة تعيين كلمة المرور">

    <title>{{ config('app.name', 'Fursaana') }} - إعادة تعيين كلمة المرور</title>
...
<body class="antialiased pattern-bg">
    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12">
        <div class="max-w-md w-full space-y-8">
            ...
            <!-- Reset Password Form -->
            <div class="reset-card rounded-3xl p-8">
                <!-- Validation Errors -->
                @if ($errors->any())
